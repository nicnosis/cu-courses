...
Today, you will begin watching _Building a Brand_, a YouTube series by TheFutur that walks through the entire creative process of building brands.

For today, watch these two episodes:
 * [1 - Starting the Branding Process](https://www.youtube.com/watch?v=mxgOY2Ms-YI&list=PLzKJi2GjpkEFsV13D3WPm5s6tZVkvKJ1-&index=2)
 * [2 - Defining the Customer](https://www.youtube.com/watch?v=fZD-IFlKb68&list=PLzKJi2GjpkEFsV13D3WPm5s6tZVkvKJ1-&index=3)
 * There is no `participation` submission for today; however watching this videos will inspire your design process for Project Three.

You will also want to read the instructions for both Homework Three and Project Three (links below).

#### Wednesday - 11/15
__First: Let's have a poll regarding Monday.__

In this class activity, you will work in teams to analyze and discuss four significant brand launches. Each team will focus on one brand and answer the questions related to that brand's launch.
...
### At Home
For Monday (11/20), you must have your Project 3 proposal completed.
